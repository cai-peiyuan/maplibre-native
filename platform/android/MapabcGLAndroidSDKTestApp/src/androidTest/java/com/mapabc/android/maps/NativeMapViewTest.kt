...
class NativeMapViewTest : AppCenter() {
    ...
    fun testFlyTo() {
        ...
        val actual = nativeMapView.cameraPosition
        assertEquals("Bearing should match", expected.bearing, actual.bearing, _root_ide_package_.com.mapabc.android.testapp.utils.TestConstants.BEARING_DELTA)
        assertEquals("Latitude should match", expected.target!!.latitude, actual.target!!.latitude, _root_ide_package_.com.mapabc.android.testapp.utils.TestConstants.LAT_LNG_DELTA)
        assertEquals("Longitude should match", expected.target!!.longitude, actual.target!!.longitude, _root_ide_package_.com.mapabc.android.testapp.utils.TestConstants.LAT_LNG_DELTA)
        assertEquals("Tilt should match", expected.tilt, actual.tilt, _root_ide_package_.com.mapabc.android.testapp.utils.TestConstants.TILT_DELTA)
        assertEquals("Zoom should match", expected.zoom, actual.zoom, _root_ide_package_.com.mapabc.android.testapp.utils.TestConstants.ZOOM_DELTA)
