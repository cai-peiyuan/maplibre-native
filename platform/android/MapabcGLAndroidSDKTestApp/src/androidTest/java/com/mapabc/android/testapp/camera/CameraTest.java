...
import com.mapabc.android.testapp.activity.espresso.DeviceIndependentTestActivity;
...
public abstract class CameraTest extends BaseTest {
  ...
  private void verifyCameraPosition(MapLibreMap maplibreMap, LatLng moveTarget, double moveZoom, double moveBearing,
    ...
    Assert.assertEquals("Moved camera position latitude should match", cameraPosition.target.getLatitude(),
